...
import { ArrowDown, Mail, Github, Linkedin, Terminal, Cpu } from "lucide-react";
      ...
      <div className="p-4 max-w-7xl  mx-auto relative z-10 w-full pt-20 md:pt-0">
        <div className="flex flex-col items-start justify-center min-h-[60vh]">
          ...
          >
            ...
            <span className="text-xs font-mono text-primary tracking-wider">SYSTEM_READY // V.2.0.25</span>
          </motion.div>

          {/* Main Title - Massive */}
          <h1 className="text-5xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 leading-tight pb-4">
            Manikya Rathna.
          </h1>
          ...
          >
            <a 
              href="#projects"
              className="px-8 py-4 rounded-full bg-primary text-black font-bold text-sm hover:scale-105 transition-transform duration-200 flex items-center gap-2"
            >
